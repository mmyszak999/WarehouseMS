...
class User(Base):
    ...
    can_move_goods = Column(Boolean, nullable=False, server_default="false")
    can_recept_goods = Column(Boolean, nullable=False, server_default="false")
    can_issue_goods = Column(Boolean, nullable=False, server_default="false")