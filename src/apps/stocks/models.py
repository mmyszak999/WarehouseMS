...
class UserStock(Base):
    ...
    stock = relationship('Stock', back_populates='stock_user_history', foreign_keys=[stock_id])
    ...
    from_waiting_room = relationship('WaitingRoom', foreign_keys=[from_waiting_room_id])
