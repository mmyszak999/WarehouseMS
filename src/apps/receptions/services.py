...
async def base_create_reception(
    ...
    rack_level_ids = [
        product.get("rack_level_id", None) for product in products_data
    ]
    ...
    session.add(new_reception)
    await session.flush()
    return products, product_counts, new_reception, waiting_rooms_ids, rack_level_slots_ids, rack_level_ids
...
async def create_reception(
    ...
    products, product_counts, new_reception, waiting_room_ids, rack_level_slots_ids, rack_level_ids = (
