...
from src.apps.waiting_rooms.schemas import WaitingRoomInputSchema, WaitingRoomUpdateSchema
from src.core.factory.core import SchemaFactory
from src.core.utils.faker import set_waiting_room_weight, set_waiting_room_stocks
