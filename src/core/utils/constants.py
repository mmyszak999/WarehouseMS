...
FORBIDDEN_FIELDS = [
    "id", "password", "user_id", "stock_user_history", "rack_level_id",
    "rack_id", "section_id", "warehouse_id", "stock_id", "rack_level_slot_id",
    "waiting_room_id", "reception_id", "product_id", "is_superuser", "is_staff",
    "has_password_set",
    ]
