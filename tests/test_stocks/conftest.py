...
from src.apps.receptions.schemas import ReceptionOutputSchema, ReceptionProductInputSchema
...
from src.core.factory.reception_factory import ReceptionInputSchemaFactory, ReceptionProductInputSchemaFactory
...
async def db_stocks(
    async_session: AsyncSession, db_products: list[ProductOutputSchema], db_staff_user: UserOutputSchema
